class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'location_permission': 'Location permission is required to show nearby towers',
      ...
      'onboarding_desc_1': 'Monitor cellular towers and network performance in real-time',
      'onboarding_title_2': 'View Towers on Map',
      'onboarding_desc_2': 'See nearby cellular towers with accessibility status',
      'onboarding_title_3': 'Track Network Stats',
      'onboarding_desc_3': 'Monitor signal strength, ping, and connection quality',
      'skip': 'Skip',
      'next': 'Next',
